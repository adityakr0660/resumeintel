...
def parse_job_description(jd_text=job_description, groq_client=None, model_name=None):
    c = groq_client or client
...
"""
    ...
    resp = c.chat.completions.create(model=m, messages=msgs, response_format={"type": "json_object"})
...
if __name__ == "__main__":
    ...
    print("Parsed Job Minimum Experience:", job.minimum_experience)
